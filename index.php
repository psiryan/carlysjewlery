...
<head>
	...
	<script src="_assets/js/libs/prefixfree.min.js"></script>
	
	<!-- This is an un-minified, complete version of Modernizr. 
		 Before you move to production, you should generate a custom build that only has the detects you need. -->
	<script src="_assets/js/libs/modernizr-2.7.1.dev.js"></script>
...
<script>window.jQuery || document.write("<script src='_assets/js/libs/jquery-1.11.0.min.js'>\x3C/script>")</script>
